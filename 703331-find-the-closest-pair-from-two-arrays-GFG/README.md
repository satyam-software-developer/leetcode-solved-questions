# [Find the closest pair from two arrays](https://www.geeksforgeeks.org/problems/find-the-closest-pair-from-two-arrays4215/1)
## Easy
...
Constraints:1 ≤ arr1.size(), arr2.size() ≤ 1051 ≤ arr1[i], arr2[i] ≤ 1091 ≤ x ≤ 109