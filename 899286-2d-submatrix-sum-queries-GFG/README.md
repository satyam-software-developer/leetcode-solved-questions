# [2D Submatrix Sum Queries](https://www.geeksforgeeks.org/problems/2d-submatrix-sum-queries/1)
## Medium
...
Input: mat[][] = [[1, 2, 3], queries[][] = [[0, 0, 1, 1], [1, 0, 2, 2]]
                [1, 1, 0],
                [4, 2, 2]]Output: [5, 10]Explanation: Query 1 selects submatrix [[1, 2], [1, 1]] → sum = 5.Query 2 selects submatrix [[1, 1, 0], [4, 2, 2]] → sum = 10.
Input: mat[][] = [[1, 1, 1], queries[][] = [[1, 1, 2, 2], [0, 0, 2, 2], [0, 2, 2, 2]]
                [1, 1, 1],
                [1, 1, 1]]Output: [4, 9, 3]Explanation: Query 1 selects submatrix [[1, 1], [1, 1]] → sum = 4.Query 2 selects submatrix [[1, 1, 1], [1, 1, 1], [1, 1, 1]] → sum = 9.Query 3 selects submatrix [[1], [1], [1]] → sum = 3.
Constraints: 1 ≤ n × m, q ≤ 1050 ≤ mat[i][j] ≤ 1040 ≤ r1 ≤ r2 ≤ n - 10 ≤ c1 ≤ c2 ≤ m - 1