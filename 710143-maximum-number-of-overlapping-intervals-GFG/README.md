# [Maximum number of overlapping Intervals](https://www.geeksforgeeks.org/problems/intersecting-intervals/1)
## Hard
...
Constraints:2&nbsp;≤ arr.size() ≤&nbsp;2 * 1041&nbsp;≤ arr[i][0] &lt; arr[i][1] ≤&nbsp;4*106