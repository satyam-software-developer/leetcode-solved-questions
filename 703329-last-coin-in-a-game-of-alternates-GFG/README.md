# [Last Coin in a Game of Alternates](https://www.geeksforgeeks.org/problems/last-coin-in-a-game-of-alternates/1)
## Easy
...
Final Output: 1
Input : arr[] = [5, 9, 2, 5]
Output : 2Explanation:Players always pick the larger coin from the two ends.
Pick 5, remaining array: [9, 2, 5]
Pick 9, remaining array: [2, 5]
Pick 5, remaining array: [2]
Final Output: 2
Input : arr[] = [11]
Output : 11Explanation:Only one coin is present in the array, so no moves are made.
Final Output: 11
