# [Number of Valid Parentheses](https://www.geeksforgeeks.org/problems/valid-number-of-parenthesis/1)
## Medium
...
Input: n = 4
Output: 2Explanation: Possibe valid expressions of length 4 are "(())" and "()()".
Input: n = 6Output: 5Explanation: Possibe valid expressions of length 6 are "((()))", "(())()", "()(())", "()()()" and "(()())".
Constraints:1 ≤ n ≤ 20